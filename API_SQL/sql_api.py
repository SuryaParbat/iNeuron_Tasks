        ...
        try:
            ...
            try:
                if operation_to_perform == 'download_data_from_table':
                    ...
                    return jsonify(f"""please select valid operation_to_perform"""),res
            ...
            return jsonify(f"""ERROR IN : def post() method, ERROR : {str(e)}"""), f"""ERROR IN : def post() method, ERROR : {str(e)}"""
